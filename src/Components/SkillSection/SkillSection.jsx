        ...
        <div className="lg:flex justify-around mt-20">
            ...
            <div className="relative">
                ...
                <div className="w-72 h-72 bg-slate-100 rounded-full absolute top-24 left-32">
                    <img className="w-24 h-24 rounded-full absolute bg-white p-2" src="https://upload.wikimedia.org/wikipedia/commons/thumb/a/a7/React-icon.svg/1200px-React-icon.svg.png" alt="" />
                    <img className="w-24 h-24 rounded-full absolute top-0 left-48" src="https://w7.pngwing.com/pngs/232/470/png-transparent-circle-js-node-node-js-programming-round-icon-popular-services-brands-vol-icon.png" alt="" />
                    ...
                    <img className="w-24 h-24 rounded-full absolute bottom-0" src="https://w7.pngwing.com/pngs/201/90/png-transparent-logo-html-html5.png" alt="" />
                    <img className="w-24 h-24 rounded-full absolute bottom-0 right-0" src="https://cdn.pixabay.com/photo/2017/08/05/11/16/logo-2582747_1280.png" alt="" />
                </div>
