...
const Banner = () => {
    return (
        <div className='lg:flex justify-around w-full bg-no-repeat bg-cover h-screen' >
            ...
            <div className="lg:w-1/2 relative mt-20">
                <div className="w-full h-screen">
                    ...
                    <img className='  absolute top-10 lg:absolute lg:-top-2 lg:h-full lg:left-10 rotate-3' src="../../../public/boy.png" alt="" />
                </div>
                ...
                <div className="flex items-center gap-5 p-2 w-60 bg-slate-200 rounded-lg absolute bottom-44 lg:bottom-10">
                    <img className="w-16" src="../../../public/crown.png" alt="" />
